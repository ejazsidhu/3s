...
@Component({
  selector: 'serach-form-sync-notes',
  templateUrl: './serach-form-sync-notes.component.html',
  styleUrls: ['./serach-form-sync-notes.component.css']
})
export class SerachFormSyncNotesComponent implements OnInit {
