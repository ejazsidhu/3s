...
import { RootComponent, VBodyComponent, VoBodyComponent, ScriptedObservationComponent, LiveStreamingComponent, MainComponent, SyncNotesComponent } from './components';
...
const routes: Routes = [
  { path: '', redirectTo: 'home', pathMatch: 'full' },
  {
    path: '', component: RootComponent, children: [
      { path: 'home/:huddle_id/:video_id', component: MainComponent },
