...
@Component({
  selector: 'app-add-huddle',
  templateUrl: './add-huddle.component.html',
  styleUrls: ['./add-huddle.component.css']
})
export class AddHuddleComponent implements OnInit {
  public huddleTypes;
  public d;
  ...
  private formatEditableHuddle(data) {
    ...
    this.huddle_data.huddle_type = 2;//Number(data.huddle_type); // huddle type added b ejaz 8-july-2019
  ...
  private assignFixRole(user, role_id) {
    ...
    this.huddle_data.huddle_type = 2;
  ...
  private assignRole(user) {
    ...
    if (this.huddle_data.huddle_type == 2) {
  ...
  public submitHuddle() {
    ...
    let json = this.prepareHuddleData("coaching");
