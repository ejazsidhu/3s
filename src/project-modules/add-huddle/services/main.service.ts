...
export class MainService {
	...
	private folderIdSource = new BehaviorSubject<number | string>(-1);
	public folderId$ = this.folderIdSource.asObservable();

	private isDirtyAssessmentHuddleMoreSettingFormSource = new BehaviorSubject<boolean>(false);
	public isDirtyAssessmentHuddleMoreSettingForm$ = this.isDirtyAssessmentHuddleMoreSettingFormSource.asObservable();
	private assessmentHuddleMoreSettingFrameworksSource = new BehaviorSubject<any>([]);
	public assessmentHuddleMoreSettingFrameworks$ = this.assessmentHuddleMoreSettingFrameworksSource.asObservable();
	...
	public updateIsDirtyAssessmentHuddleMoreSettingFormStatus(status: boolean) {
		this.isDirtyAssessmentHuddleMoreSettingFormSource.next(status);
	}

	public updateAssessmentHuddleMoreSettingFrameworks(frameworks: any) {
		this.assessmentHuddleMoreSettingFrameworksSource.next(frameworks);
	}

	public updateFolderId(folderId: number | string) {
