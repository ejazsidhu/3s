...
@Component({
  selector: 'app-resurce-grid',
  templateUrl: './resurce-grid.component.html',
  styleUrls: ['./resurce-grid.component.css']
})
export class ResurceGridComponent implements OnInit, OnDestroy {
